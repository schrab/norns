...
// SSD1325 Command Set (SSD1325 Rev 2.1 datasheet, Command Table P30-33)
...
#define SSD1325_SET_REMAP 0xA0
#define SSD1325_SET_DISPLAY_START_LINE 0xA1
#define SSD1325_SET_DISPLAY_OFFSET 0xA2
// A4h=Normal Display (RESET), A5h=All ON, A6h=All OFF, A7h=Inverse
#define SSD1325_SET_DISPLAY_MODE_NORMAL 0xA4
#define SSD1325_SET_DISPLAY_MODE_ALL_ON  0xA5
#define SSD1325_SET_DISPLAY_MODE_ALL_OFF 0xA6
#define SSD1325_SET_DISPLAY_MODE_INVERSE 0xA7
#define SSD1325_SET_MULTIPLEX_RATIO 0xA8
...
typedef enum {
    SSD1325_DISPLAY_MODE_NORMAL = 0xA4,
    SSD1325_DISPLAY_MODE_ALL_ON = 0xA5,
    SSD1325_DISPLAY_MODE_ALL_OFF = 0xA6,
    SSD1325_DISPLAY_MODE_INVERT = 0xA7,
